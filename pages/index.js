      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to Tenebris Punks {ens ? ens : address}!
          </h1>
          <div className={styles.description}>
            Its an NFT collection for Tenebris Punks.
          </div>
          {renderButton()}
        </div>
        <div>
          <img className={styles.image} src="./Tenebris.png" />
        </div>
      </div>

      <footer className={styles.footer}>
        Made with &#10084; by Tenebris Punks
      </footer>
    </div>
  );
}
